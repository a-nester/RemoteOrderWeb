...
export default function RealizationList() {
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 shadow hidden md:block rounded-lg overflow-hidden">
            ...
            <div className="md:hidden space-y-4 px-4">
                 {realizations.map((item) => (
                     <div key={item.id} className="bg-white dark:bg-gray-800 shadow rounded-lg p-4 space-y-2">
                         <div className="flex justify-between items-start">
                             <div>
                                 <span className="text-sm font-bold text-gray-900 dark:text-white">#{item.number}</span>
