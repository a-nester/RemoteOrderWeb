...
export default function OrderDetails() {
  ...
  const handleCreateWaybill = async () => {
    ...
    if (
      !window.confirm(
        t("common.confirmCreateWaybill", "Create waybill from this order?"),
      )
    )
      return;
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-8 bg-white dark:bg-gray-800 shadow-lg rounded-lg print:shadow-none print:w-full print:m-0 print:p-0">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8 print:hidden">
        <button
          onClick={() => navigate(-1)}
          className="flex items-center text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white mb-2 md:mb-0"
        >
        ...
        <div className="flex flex-wrap gap-2">
          ...
          >
            ...
            {/* Fallback to FileText just in case Edit is not available without import error */}
            {t("action.edit", "Edit")}
          </button>
          <button
      ...
      >
        ...
        <div className="mb-6 text-sm">
          ...
          <div className="flex mb-2">
            <div className="w-40 font-bold underline text-left">
              {t("print.saleCondition", "Sale Condition")}
            </div>
            <div className="text-left">
              {t("print.cash", "Cash settlement")}
            </div>
          </div>
        </div>
